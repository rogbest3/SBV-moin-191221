...
시행일자: 2019년 1월 10일
							...
							<div class="themoin-sms-request">
								...
								<div :class="codes_clazz" @click.prevent="dropdown_toggle">	
									<label>국가 번호 (Country Code)</label>
									<a id="phone1" class="dropdown-toggle">{{code_display}}
										<img class="pull-right" src="https://img.themoin.com/public/img/ic-dropdown-p.png">
									</a>
									<ul class="dropdown-menu">
										<li v-for="code of codes" :key="code.text" @click.prevent="code_select(code)"><a @click.prevent="code_a(code)">{{code.text}}</a></li>
									</ul>
								...
								<div class="themoin-composite-input moin-input-group phone2">
									...
									<p :class="phone_error.p">{{phone_error.phone_error_text}}</p>
									<!-- <p class="moin-error active">값을 입력하여야 합니다.</p> -->
								</div>
...
export default{
	data(){
		return{
			...
			cname : '',
			cphone : '',
			codes : [ { text : '+1 (United States)' }, { text : '+1 (Canada)' }, { text : '+1242 (Bahamas)' }, { text : '+1246 (Barbados)' }, { text : '+1264 (Anguilla)' }, { text : '+1268 (Antigua and Barbuda)' }, { text : '+1284 (British Virgin Islands)' }, { text : '+1340 (United States Virgin Islands)' }, { text : '+1345 (Cayman Islands)' }, { text : '+1441 (Bermuda)' }, { text : '+1473 (Grenada)' }, { text : '+1649 (Turks and Caicos Islands)' }, { text : '+1664 (Montserrat)' }, { text : '+1670 (Northern Mariana Islands)' }, { text : '+1671 (Guam)' }, { text : '+1684 (American Samoa)' }, { text : '+1721 (Sint Maarten)' }, { text : '+1758 (Saint Lucia)' }, { text : '+1767 (Dominica)' }, { text : '+1784 (Saint Vincent and the Grenadines)' }, { text : '+1787 (Puerto Rico)' }, { text : '+1809 (Dominican Republic)' }, { text : '+1868 (Trinidad and Tobago)' }, { text : '+1869 (Saint Kitts and Nevis)' }, { text : '+1876 (Jamaica)' }, { text : '+20 (Egypt)' }, { text : '+211 (South Sudan)' }, { text : '+212 (Western Sahara)' }, { text : '+212 (Morocco)' }, { text : '+213 (Algeria)' }, { text : '+216 (Tunisia)' }, { text : '+218 (Libya)' }, { text : '+220 (Gambia)' }, { text : '+221 (Senegal)' }, { text : '+222 (Mauritania)' }, { text : '+223 (Mali)' }, { text : '+224 (Guinea)' }, { text : '+225 (Ivory Coast)' }, { text : '+226 (Burkina Faso)' }, { text : '+227 (Niger)' }, { text : '+228 (Togo)' }, { text : '+229 (Benin)' }, { text : '+230 (Mauritius)' }, { text : '+231 (Liberia)' }, { text : '+232 (Sierra Leone)' }, { text : '+233 (Ghana)' }, { text : '+234 (Nigeria)' }, { text : '+235 (Chad)' }, { text : '+236 (Central African Republic)' }, { text : '+237 (Cameroon)' }, { text : '+238 (Cape Verde)' }, { text : '+239 (São Tomé and Príncipe)' }, { text : '+240 (Equatorial Guinea)' }, { text : '+241 (Gabon)' }, { text : '+242 (Republic of the Congo)' }, { text : '+243 (DR Congo)' }, { text : '+244 (Angola)' }, { text : '+245 (Guinea-Bissau)' }, { text : '+246 (British Indian Ocean Territory)' }, { text : '+248 (Seychelles)' }, { text : '+249 (Sudan)' }, { text : '+250 (Rwanda)' }, { text : '+251 (Ethiopia)' }, { text : '+252 (Somalia)' }, { text : '+253 (Djibouti)' }, { text : '+254 (Kenya)' }, { text : '+255 (Tanzania)' }, { text : '+256 (Uganda)' }, { text : '+257 (Burundi)' }, { text : '+258 (Mozambique)' }, { text : '+260 (Zambia)' }, { text : '+261 (Madagascar)' }, { text : '+262 (Mayotte)' }, { text : '+262 (Réunion)' }, { text : '+263 (Zimbabwe)' }, { text : '+264 (Namibia)' }, { text : '+265 (Malawi)' }, { text : '+266 (Lesotho)' }, { text : '+267 (Botswana)' }, { text : '+268 (Swaziland)' }, { text : '+269 (Comoros)' }, { text : '+27 (South Africa)' }, { text : '+291 (Eritrea)' }, { text : '+297 (Aruba)' }, { text : '+298 (Faroe Islands)' }, { text : '+299 (Greenland)' }, { text : '+30 (Greece)' }, { text : '+31 (Netherlands)' }, { text : '+32 (Belgium)' }, { text : '+33 (France)' }, { text : '+34 (Spain)' }, { text : '+350 (Gibraltar)' }, { text : '+351 (Portugal)' }, { text : '+352 (Luxembourg)' }, { text : '+353 (Ireland)' }, { text : '+354 (Iceland)' }, { text : '+355 (Albania)' }, { text : '+356 (Malta)' }, { text : '+357 (Cyprus)' }, { text : '+358 (Åland Islands)' }, { text : '+358 (Finland)' }, { text : '+359 (Bulgaria)' }, { text : '+36 (Hungary)' }, { text : '+370 (Lithuania)' }, { text : '+371 (Latvia)' }, { text : '+372 (Estonia)' }, { text : '+373 (Moldova)' }, { text : '+374 (Armenia)' }, { text : '+375 (Belarus)' }, { text : '+376 (Andorra)' }, { text : '+377 (Monaco)' }, { text : '+378 (San Marino)' }, { text : '+380 (Ukraine)' }, { text : '+381 (Serbia)' }, { text : '+382 (Montenegro)' }, { text : '+383 (Kosovo)' }, { text : '+385 (Croatia)' }, { text : '+386 (Slovenia)' }, { text : '+387 (Bosnia and Herzegovina)' }, { text : '+389 (Macedonia)' }, { text : '+39 (Italy)' }, { text : '+3906698 (Vatican City)' }, { text : '+40 (Romania)' }, { text : '+41 (Switzerland)' }, { text : '+420 (Czechia)' }, { text : '+421 (Slovakia)' }, { text : '+423 (Liechtenstein)' }, { text : '+43 (Austria)' }, { text : '+44 (United Kingdom)' }, { text : '+44 (Guernsey)' }, { text : '+44 (Isle of Man)' }, { text : '+44 (Jersey)' }, { text : '+45 (Denmark)' }, { text : '+46 (Sweden)' }, { text : '+47 (Norway)' }, { text : '+4779 (Svalbard and Jan Mayen)' }, { text : '+48 (Poland)' }, { text : '+49 (Germany)' }, { text : '+500 (Falkland Islands)' }, { text : '+500 (South Georgia)' }, { text : '+501 (Belize)' }, { text : '+502 (Guatemala)' }, { text : '+503 (El Salvador)' }, { text : '+504 (Honduras)' }, { text : '+505 (Nicaragua)' }, { text : '+506 (Costa Rica)' }, { text : '+507 (Panama)' }, { text : '+508 (Saint Pierre and Miquelon)' }, { text : '+509 (Haiti)' }, { text : '+51 (Peru)' }, { text : '+52 (Mexico)' }, { text : '+53 (Cuba)' }, { text : '+54 (Argentina)' }, { text : '+55 (Brazil)' }, { text : '+56 (Chile)' }, { text : '+57 (Colombia)' }, { text : '+58 (Venezuela)' }, { text : '+590 (Saint Barthélemy)' }, { text : '+590 (Guadeloupe)' }, { text : '+590 (Saint Martin)' }, { text : '+591 (Bolivia)' }, { text : '+592 (Guyana)' }, { text : '+593 (Ecuador)' }, { text : '+594 (French Guiana)' }, { text : '+595 (Paraguay)' }, { text : '+596 (Martinique)' }, { text : '+597 (Suriname)' }, { text : '+598 (Uruguay)' }, { text : '+5999 (Curaçao)' }, { text : '+60 (Malaysia)' }, { text : '+61 (Australia)' }, { text : '+61 (Cocos (Keeling) Islands)' }, { text : '+61 (Christmas Island)' }, { text : '+62 (Indonesia)' }, { text : '+63 (Philippines)' }, { text : '+64 (New Zealand)' }, { text : '+64 (Pitcairn Islands)' }, { text : '+65 (Singapore)' }, { text : '+66 (Thailand)' }, { text : '+670 (Timor-Leste)' }, { text : '+672 (Norfolk Island)' }, { text : '+673 (Brunei)' }, { text : '+674 (Nauru)' }, { text : '+675 (Papua New Guinea)' }, { text : '+676 (Tonga)' }, { text : '+677 (Solomon Islands)' }, { text : '+678 (Vanuatu)' }, { text : '+679 (Fiji)' }, { text : '+680 (Palau)' }, { text : '+681 (Wallis and Futuna)' }, { text : '+682 (Cook Islands)' }, { text : '+683 (Niue)' }, { text : '+685 (Samoa)' }, { text : '+686 (Kiribati)' }, { text : '+687 (New Caledonia)' }, { text : '+688 (Tuvalu)' }, { text : '+689 (French Polynesia)' }, { text : '+690 (Tokelau)' }, { text : '+691 (Micronesia)' }, { text : '+692 (Marshall Islands)' }, { text : '+7 (Russia)' }, { text : '+76 (Kazakhstan)' }, { text : '+81 (Japan)' }, { text : '+82 (South Korea)' }, { text : '+84 (Vietnam)' }, { text : '+850 (North Korea)' }, { text : '+852 (Hong Kong)' }, { text : '+853 (Macau)' }, { text : '+855 (Cambodia)' }, { text : '+856 (Laos)' }, { text : '+86 (China)' }, { text : '+880 (Bangladesh)' }, { text : '+886 (Taiwan)' }, { text : '+90 (Turkey)' }, { text : '+91 (India)' }, { text : '+92 (Pakistan)' }, { text : '+93 (Afghanistan)' }, { text : '+94 (Sri Lanka)' }, { text : '+95 (Myanmar)' }, { text : '+960 (Maldives)' }, { text : '+961 (Lebanon)' }, { text : '+962 (Jordan)' }, { text : '+963 (Syria)' }, { text : '+964 (Iraq)' }, { text : '+965 (Kuwait)' }, { text : '+966 (Saudi Arabia)' }, { text : '+967 (Yemen)' }, { text : '+968 (Oman)' }, { text : '+970 (Palestine)' }, { text : '+971 (United Arab Emirates)' }, { text : '+972 (Israel)' }, { text : '+973 (Bahrain)' }, { text : '+974 (Qatar)' }, { text : '+975 (Bhutan)' }, { text : '+976 (Mongolia)' }, { text : '+977 (Nepal)' }, { text : '+98 (Iran)' }, { text : '+992 (Tajikistan)' }, { text : '+993 (Turkmenistan)' }, { text : '+994 (Azerbaijan)' }, { text : '+995 (Georgia)' }, { text : '+996 (Kyrgyzstan)' }, { text : '+998 (Uzbekistan)' } 
					],
			code_display : '+82 (South Korea)',
			codes_clazz : 'moin-input-group moin-dropdown',
			phone_error: [ { phone_error_clazz : 'moin-error', phone_error_text : ''} ]
		}
	},
	whatch : {
	...
	methods : {
		...
		dropdown_toggle(){
			this.codes_clazz = ( this.codes_clazz == 'moin-input-group moin-dropdown') ? 'moin-input-group moin-dropdown open' : 'moin-input-group moin-dropdown'	
		},
		// code_select(i){
			
		// },
		code_a(i){
			this.code_display = i.text
		},
		phone_error_show(){
			this.phone_error = (this.cphone == '') 
							? { phone_error_clazz : 'moin-error', phone_error_text : ''} 
							: { phone_error_clazz : 'moin-error active', phone_error_text : '값을 입력하여야 합니다.'} 
		}
	}
}
</script>
